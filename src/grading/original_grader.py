...
Call: 
grade_answer(given_answer: str, ground_truth: str) or 
semantic_similarity(given_answer: str, ground_truth: str)
"""
import re
import sympy
...
def extract_boxed_answer(input_string):
    ...
    # If a match is found, return the boxed content
    if match:
...
def grade_answer(response: str, ground_truth: str) -> bool:
    """
    ...
    if "boxed" in response:
        ...
        given_answer = extract_num_answer(response)
...
def semantic_similarity(response: str, solution: str) -> bool: 
    ...
    pred_emb = model.encode(response, convert_to_tensor=True)
    ans_emb = model.encode(solution, convert_to_tensor=True)
